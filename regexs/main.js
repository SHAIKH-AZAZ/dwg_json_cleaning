...
import { extractDiaRegex10 } from "./DiaRegex/Dia/10DiaFiltering.js";
...
export function runExtractionRegex(customInputPath = "../cleanjson/cleaned_texts.json") {
  try {
    const inputPath = path.join(__dirname, customInputPath);
    ...
    const outputs = [
      ...
      { name: "./DiaRegex/Dia/10DiaBar.json", data: extractDiaRegex10(inputArray) },
